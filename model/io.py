...
def upsample_wav(wav, model, r=2, sr=16000):
  # load signal
  x_hr, fs = librosa.load(wav, sr=sr)
  ...
  librosa.output.write_wav(outname + '.lr.wav', x_lr, int(fs / r))
  ...
  S = get_spectrum(x_lr, n_fft=int(2048/r))
